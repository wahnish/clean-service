        ...
        <main className={""}>
          ...
          <section className={"py-16 bg-white"}>
            <div className={"container mx-auto px-4"}>
              ...
              <div className={"max-w-xl mx-auto"}>
                <QuoteRequestForm className={""}></QuoteRequestForm>
              </div>
            </div>
          </section>
          <section className={"py-16 bg-primary text-white"}>
            <div className={"container mx-auto px-4 text-center"}>
              ...
              <p className={"text-xl mb-8 max-w-2xl mx-auto"}>
                Join hundreds of satisfied customers who trust Healthy Clean
                Homes for their cleaning needs.
              </p>
              <div className={"flex flex-col sm:flex-row justify-center gap-4"}>
                <a
                  href={"tel:5551234567"}
                  className={
                    "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-primary hover:bg-white/90 h-10 px-4 py-2"
                  }
                >
                  Call Us Now
                </a>
                <a
                  href={"#quote-form"}
                  className={
                    "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-white bg-transparent hover:bg-white/10 h-10 px-4 py-2"
                  }
                >
                  Request a Quote
                </a>
