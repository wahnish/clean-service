...
const Navbar = () => {
  ...
  return (
    <nav
      className={`w-full fixed top-0 z-50 transition-all duration-300 ${isScrolled || isOpen ? "bg-primary shadow-md py-2" : "bg-transparent py-4"}`}
    >
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={`transition-transform duration-300 ${locationsOpen ? "rotate-180" : ""}`}
                />
              </div>
              {locationsOpen && (
                <div className="pl-4 space-y-2 border-l-2 border-white/20">
