                ...
                <div className="w-3/4 p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Removal of construction debris from yard and landscaping
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
                      ...
                      <span>Cleaning of exterior windows and door frames</span>
                    </li>
                    <li className="flex items-start">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>
                        Pressure washing of driveways and walkways (optional)
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
                      ...
                      <span>
                        Cleaning of exterior light fixtures and mailbox
                      </span>
                    </li>
                  </ul>
                </div>
